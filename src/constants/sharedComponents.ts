...
export const getDeleteModalTitle = (resource: string) => `Are you sure delete this ${resource}?`;

export const getFileSuccessMessage = (name?: string) => `${name} file uploaded successfully`;

export const getFileErrorMessage = (name?: string) => `${name} file upload failed.`;
